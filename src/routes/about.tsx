      ...
      <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <div className="space-y-5 text-muted-foreground leading-relaxed">
            <p>Punjab Foods is a family-run kitchen in Rawalpindi, born from a simple belief: that the best food comes from the oldest recipes — passed down, never compromised.</p>
            <p>Our pulao rice is hand-soaked, slow-cooked over open flame, and finished with whole spices ground in-house. Our kababs are shaped by hand, our roast charred to order, our zarda perfumed with kewra and saffron.</p>
            <p>Whether it's a single plate of Chicken Pulao or a 10-kilo deg for your wedding — we cook the same way, with the same heart.</p>
          </div>
        </div>
